...
// import "./styles.css";
var weeklyDistance = 40;
var splitA = 0.55,
    splitB = 0.65;
var weeklyDistanceInput = document.getElementById("weekly-distance-input"),
...
weeklyDistanceInput.addEventListener("input", function (_ref) {
...
function calculateDailyDistances(weeklyDistance) {
  var weekDistance = Math.round(weeklyDistance * (1 - splitA)),
      weekendDistance = weeklyDistance - weekDistance;
  var tuesdayDistance = Math.round(weekDistance * (1 - splitB)),
...
function drawChart() {
  var dailyDistances = calculateDailyDistances(weeklyDistance);
  console.log(dailyDistances);
  var data = window.google.visualization.arrayToDataTable([["Day", "Distance", {
    role: "annotation"
  }]].concat(_toConsumableArray(dailyDistances.map(function (_ref4) {
    var _ref5 = _slicedToArray(_ref4, 2),
        day = _ref5[0],
        distance = _ref5[1];

    return [day, distance, distance];
  }))));
  var options = {
